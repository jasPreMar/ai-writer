...
const Toolbar = ({
  ...
  return (
    <div
      className={`Toolbar fixed top-0 left-0 right-0 bg-gray-800 text-white flex items-center justify-between h-12 px-4 transition-transform duration-300 ${isToolbarVisible ? '' : 'hidden-toolbar'
        }`}
